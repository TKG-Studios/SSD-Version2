...
public class PlayerCombat : MonoBehaviour {
	...
	[HideInInspector]
	public int HitKnockDownThreshold = 3; //the number of times the player can be hit before being knocked down
	[HideInInspector]
	...
	public virtual void CombatInputEvent(string action) {
	...
	//we are hit
	public virtual void Hit(DamageObject d) {
